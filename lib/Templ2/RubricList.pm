...
my $templ = lc($template).'/show_rubric';
...
$message = MyBlog::AuthorizeForm->authorize_form( $self, $templ );
...
my $rubric_link = "<a href=\"/rubric/$rubric_id\" id=\"rubric_style_custom\">$rubric_name</a>\n";
